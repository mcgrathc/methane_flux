...
X_columns_0 = ['TA_F', 'WTD_F', 'PA_F',  'NEE_F', 'nitrogen_0-5cm_mean']

X_columns_1 = ['P_F', 'TA_F', 'WTD_F', 'H_F', 'soc_0-5cm_mean']
...
plt.savefig('feature_importance_comparison_clusters_sum_reduced.png', bbox_inches='tight', dpi=300)